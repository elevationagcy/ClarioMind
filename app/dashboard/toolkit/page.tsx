        ...
        {loading ? (
          ...
          >
            ...
            {copingTools.length > 0 && (
              <motion.div variants={fadeInUp}>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold text-gray-900">Coping Skills</h2>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {copingTools.map((tool) => (
                    ...
                    >
                      ...
                      >
                        <div className="w-full aspect-video bg-amber-100 rounded-xl flex items-center justify-center text-5xl mb-3 relative overflow-hidden">
                        ...
                        <p className="text-center font-semibold text-gray-900 text-sm line-clamp-2">{tool.title}</p>
                      </Card>
                    </motion.div>
                  ))}
                </div>
            ...
            {mindfulnessTools.length > 0 && (
              <motion.div variants={fadeInUp}>
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold text-gray-900">Mindfulness & Mental Health</h2>
                </div>
                <p className="text-gray-600 text-sm mb-4">
                  ...
                  {mindfulnessTools.map((tool) => (
                    ...
                    >
                      <Card
                        ...
                        onClick={() => router.push(`/dashboard/lesson/${tool.id}`)}
                      >
                      <div className="w-full aspect-video bg-purple-100 rounded-xl flex items-center justify-center text-5xl mb-3 relative overflow-hidden">
                        {tool.icon?.startsWith('http') ? (
                          <Image
                            src={tool.icon}
                            alt={tool.title}
            ...
            {/* Reflections Section */}
            <motion.div variants={fadeInUp}>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Reflections</h2>
